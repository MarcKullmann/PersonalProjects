...
```{r Introducing the OSM-Map, include=TRUE, warning=FALSE}
...
```{r Plot locations, include=TRUE, warning=FALSE}
...
```{r Plot Price in relation to location, include=TRUE, warning=FALSE}
autoplot(OpenStreetMap::openproj(map_bw)) +
  geom_point(data = data, aes(x = Lng,
                              y = Lat, 
                              shape = District, 
